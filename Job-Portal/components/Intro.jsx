    ...
    <>
      ...
      <div className='w-full  h-full flex items-center lg:justify-start py-24 justify-center flex-wrap  '>
        <div className='lg:w-3/6 w-full sm:p-2 h-full my-2 flex items-center justify-center px-4 md:items-start md:justify-start md:p-20 flex-col '>
          <h1 className='md:text-6xl text-2xl sm:text-2xl font-extrabold mb-4 text-black '>Applying for <span className='text-indigo-600'>Jobs...</span> </h1>
          <p className='md:text-lg sm:text-sm text-xs mb-20 text-gray-400'>Thousands of Peoples are searching daily in this portal, 100 user added job portal!</p>
        ...
        <div className='w-3/6 my-2 h-full bg-gray-200 hidden items-center justify-center flex-col p-20 lg:flex'>
          <Image width={600} height={700} src="/intro3.png" alt="no-image-found" />
        </div>
      </div>
      {
        doneSearch && (
